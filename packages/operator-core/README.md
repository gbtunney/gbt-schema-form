<!--
  This header mirrors the template’s README with badges and a succinct description.
  Feel free to update badges (npm version, build status, coverage, size) once published.
-->
